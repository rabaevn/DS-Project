...
```
```{r}
cleaned_data$are_there_local_examples_in_the_content_e_g_r[is.na(cleaned_data$are_there_local_examples_in_the_content_e_g_r)] <- 0
cleaned_data$does_the_content_present_advantages_and_disad[is.na(cleaned_data$does_the_content_present_advantages_and_disad)] <- 0
```
...
cleaned_data <- replace_null_with_mode(cleaned_data, "how_accurate_is_the_scientific_content_presen", "langs")
cleaned_data <- replace_null_with_mode(cleaned_data, "is_a_scientific_background_high_school_or_abo", "langs")
```
